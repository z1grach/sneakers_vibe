                ...
                <div className={styles.textContent}>
                    <div>
                        ...
                        <p>Вы можете вернуть купленный товар в нашем магазине при условии, если: сохранен товарный вид
                            изделия (в том числе оригинальная упаковка); срок обращения не превышает 14 календарных
                            дней, не
                            считая дня совершения покупки. Возврат товара из интернет-магазина осуществляется через СДЕК
                            по
                        ...
                        <p>Все случаи возврата товаров в нашем магазине регулируются действующими на территории России
                            законами:</p>
                        <p>Постановлением Правительства РФ от 31.12.2020 N 2463 "Об утверждении Правил продажи товаров
                            по
                            договору розничной купли-продажи, перечня товаров длительного пользования, на которые не
                            распространяется требование потребителя о безвозмездном предоставлении ему товара,
                            обладающего
                            этими же основными потребительскими свойствами, на период ремонта или замены такого товара,
                            и
                    ...
                    <div>
                        ...
                        <p>Как только возвращенный вами товар будет получен и проверен на нашем складе, мы
                            незамедлительно
                            свяжемся с вами.</p>
                    ...
                    <div>
                        ...
                        <p>Почтовые расходы, связанные с возвратом товара надлежащего качества оплачиваются
                            покупателем.</p>
                        <p>Исключением являются: товар ненадлежащего качества, ошибочно отправленный товар. В таких
                            случаях
                            почтовые расходы компенсируются.</p>
                    </div>
                    <div>
                        <h1>На возврат даётся 14 дней, с какого момента начинается отсчёт?</h1>
                        <p>У вас есть 14 календарных дней, не считая дня получения заказа, чтобы произвести возврат
                            товара
